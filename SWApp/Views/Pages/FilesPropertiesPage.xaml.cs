...
namespace SWApp.Views.Pages
{
            ...
            string[] optionsStr =
 {
        ...
        {
            _viewModel.SaveToExcel(dgAllProperties, tbSavedIndex.Text, tbAssyemblyFilepath.Text, tbConfigName.Text, tbAssemblyDescription.Text, tbAssemblySize.Text, tbAssemblyMass.Text);
        }
